...
// --- EKLENDI: services verisini çeken fonksiyon (Footer için gerekti) ---
...
// --- EKLENDI: kategori verisini çeken fonksiyon (Header/Footer için) ---
...
export default async function Page({ params }) {
  ...
  // --- DÜZELTME: Header ve Footer için gerekli data çekiliyor ---
  ...
  const category = categoryData; // Footer/Header kullandığı forma uygun şekilde geçiriyoruz
