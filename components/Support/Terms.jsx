    ...
    <div>
      ...
      <div className="supportTextBox">
        ...
        <p>
          ...
          line with this Privacy Policy ("Data Controller"). <br />This Privacy Policy
          ("Policy") explains how Hostinger processes information that can be
          used to directly or indirectly identify an individual ("Personal
          Data") collected on our Site, our services (“Service”), forums and our
          mobile applications ("Platform"). All personal data are processed in
          accordance with the General Data Protection Regulation (EU) 2016/679
          (“GDPR”) and EU-U.S. and Swiss-U.S. Privacy Shield Frameworks,
          designed by the U.S. Department of Commerce and the European
          Commission and Swiss Administration. For any questions regarding this
          Policy or any requests regarding the processing of personal data,
          please contact us at gdpr@hostinger.com.
        </p>
      </div>
